...
The file name can be found near the end of the first line of the error stack trace.

You can fill in the answer to the question like so:
...
The line number can be found at the end of the first line of the error stack trace.
3.

On line 18 of the text file, fill in the type of the error being thrown in the example stack trace.

The error type can be found at the beginning of the fifth line of the error stack trace.
4.

On line 20 of the text file, fill in the description of the error being thrown in the example stack trace.

The error description can be found after the error type on the fifth line of the error stack trace.
Concept Review
Want to quickly review some of the concepts you’ve been learning? Take a look at this material's cheatsheet!


=======================================================================================================================
error_stack_trace.txt
